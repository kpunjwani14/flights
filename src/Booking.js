...
class Booking extends React.Component {
    ...
    getFlightInfo() {
        return this.state.fData.map(f => (
            ...
            <>
                <b>{f.pf} ({f.dept_air}) to {f.pt} ({f.arr_air})</b>
    ...
    async getPromos(c) {
        ...
        if (res.data[0])
            this.setState({
                discountRate:1-(parseInt(res.data[0].discount)*.01)
    ...
    getPrices() {
        ...
        this.state.fData.forEach(f => {
            ...
            rate.forEach(((pe, ind) => {
                ...
                for (let i = 0; i < ar; i++){
                    let ip=((f.price*pe-(a[ind]==='infant'?0:disc))*this.state.discountRate)
                    total+=ip
                    p.push(<>
                ...
                elem.push(
                    <Card.Body className={count === 0 ? 'padding2' : 'padding1'}>
                        ...
                        <Card.Text>
                            ...
                            <Form.Row>
                                <Form.Group className='col-md-3' as={Col} controlId={`formGridEmail${c++}`}>
                            ...
                            <Form.Group>
                                <Form.Check required inline name={`gender${count}`} type="radio" label='Male' />
                                <Form.Check inline name={`gender${count}`} type="radio" label='Female' />
                            </Form.Group>

                            <Form.Label>Date of birth</Form.Label>
                            <Form.Row>
                                <Form.Group controlId={`exampleForm.ControlSelect${c++}`}>
                                ...
                                <Form.Group style={{ marginLeft: '8px' }} controlId={`exampleForm.ControlSelect${c++}`}>
                                    <Form.Control custom required as="select">
                        ...
                        {count++ !== tot - 1 && <hr style={{ height: '1px' }}></hr>}
                    </Card.Body>
                )
            }
        })
                                                ...
                                                <Col>
                                                    <Form.Group>
                                                        <InputGroup style={{ marginTop: '10px' }}>
                                                            <Form.Control className='col-lg-4' onChange={(e) => { this.setState({ promo: e.target.value }) }} value={this.state.promo} size="lg" type="text" placeholder="Promo Code" />
                                                            <InputGroup.Append>
                                    ...
                                    <Card.Body>
                                        ...
                                        <Form.Row>
                                            <Form.Group>
                                                ...
                                                <Form.Control as='select' custom required className='col-lg-10'>
